# 🛡️ Aegis Veil — Agent Runtime Architecture
...
**Canonical flow:** Input -> Static/heuristic scan -> Risk score -> Sandbox gate -> Allow/Block + report

## Core components
Prompt/skill payload inspection, injection signatures, permission diff, sandbox enforcement, risk reporting.
