...
Skill especializada para operaciones de **security** en entornos multiagente (OpenClaw/KiloCode).

## Descripción general

Aegis Veil permite ejecutar tareas de security con un flujo seguro, reproducible y trazable.

## Cuándo usar

- Necesitas ejecución estructurada en el dominio **security**.
...
- Activación por triggers para escenarios de security.
...
**Input:** "Audita y mejora el flujo de security."
