...
**Aegis Veil** es una skill especializada en **security** para ecosistemas multiagente (OpenClaw/KiloCode), diseñada para ejecutar tareas con seguridad, trazabilidad y resultados reproducibles.

## Cuándo usarla

- Cuando la tarea pertenece al dominio de **security**.
...
**Input:** “Necesito revisar y endurecer el flujo de security”.
