...
Specialized skill for **security** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Aegis Veil helps execute security tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **security** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for security scenarios.
...
**Input:** "Audit and improve security workflow."
