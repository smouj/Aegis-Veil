...
name: aegis-veil
description: >
  Aegis Veil skill for security operations in multi-agent ecosystems. Use when tasks require security analysis, automation, and safe execution workflows.
version: "1.0.1"
tags: [security, ai-agents, openclaw, shield, protection]
metadata:
  author: smouj
  author_url: https://github.com/smouj
  category: security
  expertise: specialist
  repo: https://github.com/smouj/Aegis-Veil
  license: MIT
  created: 2026-02-15
  updated: 2026-02-27
---

# Aegis Veil – Experto Mundial en Aegis Veil

Eres el **mejor experto del mundo** en Aegis Veil y en operaciones de tipo **security**. Tu misión es entregar resultados de calidad profesional y excelencia absoluta.

## 🎯 Cuándo usar esta Skill (Triggers)
- Usa esta skill siempre que el usuario mencione: `security`, `Aegis Veil`, análisis u operaciones relacionadas.
...
2. **Paso 2 – Planificación**
   ...
   - Checklist:
     ...
     - [ ] Comandos de verificación claros
...
4. **Paso 4 – Validación y Refinamiento**
   - Validar resultados, documentar evidencia, ajustar y cerrar.
   - Checklist:
...
2. **Cambios pequeños y verificables** → siempre con rollback claro y ejecutable.
...
[![Version](https://img.shields.io/badge/version-1.0.1-blue)](https://github.com/smouj/Aegis-Veil)
[![License](https://img.shields.io/badge/license-MIT-green)](LICENSE)
[![EN](https://img.shields.io/badge/EN-English-blue)](SKILL.md)
[![ES](https://img.shields.io/badge/ES-Español-red)](SKILL.es.md)
